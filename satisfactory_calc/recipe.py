...
RECIPE: Final[dict[str | Item, Recipe]] = {
    ...
    Ingredients.turbo_rifle_ammo: # ターボライフル弾
        Recipe(
            RecipeIO(Ingredients.rifle_ammo,125).add_item(Ingredients.aluminum_casing,15).add_item(Liquid.turbo_fuel,15),
            RecipeIO(Ingredients.turbo_rifle_ammo,250),
            Building.blender,
        ),
    alternate(Ingredients.turbo_rifle_ammo):
        Recipe(
            RecipeIO(Ingredients.rifle_ammo,125).add_item(Ingredients.aluminum_casing,15).add_item(Ingredients.packaged_turbo_fuel,15),
            RecipeIO(Ingredients.turbo_rifle_ammo,250),
            Building.manufacturer,
        ),
    ...
    Ingredients.packaged_turbo_fuel: # 容器入りターボ燃料
        Recipe(
            RecipeIO(Liquid.turbo_fuel,20).add_item(Ingredients.empty_canister,20),
            RecipeIO(Ingredients.packaged_turbo_fuel,20),
            Building.packager,
        ),
    ...
    Liquid.turbo_fuel: # ターボ燃料
        Recipe(
            ...
            RecipeIO(Liquid.turbo_fuel,18.75),
            Building.refinery,
        ),
    alternate(Liquid.turbo_fuel):
        Recipe(
            RecipeIO(Ingredients.packaged_turbo_fuel,20),
            RecipeIO(Liquid.turbo_fuel,20).add_item(Ingredients.empty_canister,20),
            Building.packager,
        ),
    alternate(Liquid.turbo_fuel,2):
        Recipe(
            RecipeIO(Liquid.heavy_oil_residue,37.5).add_item(Ingredients.compacted_coal,30),
            RecipeIO(Liquid.heavy_oil_residue,30),
            Building.refinery,
        ),
    alternate(Liquid.turbo_fuel,3):
        Recipe(
...
RECIPE[byproduct(Ingredients.empty_canister, 3)] = RECIPE[alternate(Liquid.turbo_fuel)]
